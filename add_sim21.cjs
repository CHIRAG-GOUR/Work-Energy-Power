const fs = require('fs');
let code = fs.readFileSync('src/lib/simulations.js', 'utf8');
...
if (!code.includes('initSim5')) {
  fs.writeFileSync('src/lib/simulations.js', code + '\n' + simCode);
  console.log('Appended sims to simulations.js');
} else {
