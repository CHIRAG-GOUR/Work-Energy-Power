...
import { initSim1, initSim2, initSim3 } from '../lib/simulations';

const PREFIX = 'https://lms.skillizee.com';

const ChapterOneThree = () => {
  useEffect(() => {
    const t1 = setTimeout(() => initSim1(), 100);
    const t2 = setTimeout(() => initSim2(), 150);
    ...
    <div className="ui-grid" id="view-chapter-1.3">
      ...
      <article className="glass-card fade-in" style={{ animationDelay: '0.2s', gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="video-container" style={{ width: '100%', maxWidth: '800px', marginBottom: '2rem', borderRadius: '16px', overflow: 'hidden', boxShadow: 'var(--card-shadow), var(--inset-shadow)' }}>
          <iframe width="800" height="600" src="https://www.youtube.com/embed/d6MhIBpmJnE" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen style={{ display: 'block', maxWidth: '100%', height: 'auto', aspectRatio: '4/3' }}></iframe>
        </div>
        <div style={{ textAlign: 'center', width: '100%' }}>
            <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-1.png" alt="Force v" style={{ width: '100%', maxWidth: '434px', borderRadius: '1rem', marginTop: '1rem' }} />
        </div>
      </article>
      ...
      <article className="glass-card fade-in" style={{ animationDelay: '0.3s', gridColumn: '1 / -1' }}>
        ...
        <div className="info-block" style={{ padding: '2rem', background: 'var(--glass-bg)', borderRadius: '24px', boxShadow: 'var(--inner-well)' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '1rem' }}>
                <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-2.png" alt="Formula" style={{ maxWidth: '197px' }} />
            </div>
        </div>
      </article>
      ...
      <article className="glass-card fade-in" style={{ animationDelay: '0.5s', gridColumn: '1 / -1' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-3.png" alt="W=Fxs formula" style={{ maxWidth: '197px' }} />
        </div>
        ...
        <div className="side-by-side-cards">
            <div className="info-block">
                ...
                <div style={{ textAlign: 'center' }}>
                    <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-4.png" alt="W=0xs=0" style={{ maxWidth: '148px', margin: '1rem 0' }} />
                </div>
            ...
            <div className="info-block">
                ...
                <div style={{ textAlign: 'center' }}>
                    <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-5.png" alt="W=Fx0=0" style={{ maxWidth: '157px', margin: '1rem 0' }} />
                </div>
        ...
        <h3 style={{ marginTop: '3rem', color: 'var(--accent-color)' }}>Interactive: Test Force vs Displacement (Sim 1)</h3>
        <div className="simulation-container" style={{ position: 'relative', width: '100%', aspectRatio: '21/9', minHeight: '400px', borderRadius: '24px', overflow: 'hidden', boxShadow: 'var(--inner-well)', marginTop: '1rem' }}>
          ...
          <div className="sim-ui" style={{ position: 'absolute', bottom: '1.5rem', left: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <button id="sim1-btn-wall" className="btn primary-btn" style={{ padding: '0.8rem 1.5rem', borderRadius: '12px', background: 'var(--accent-color)', color: 'white', border: 'none', cursor: 'pointer', boxShadow: 'var(--card-shadow)', fontWeight: 'bold' }}>Push Wall (s=0)</button>
            <button id="sim1-btn-pebble" className="btn accent-btn" style={{ padding: '0.8rem 1.5rem', borderRadius: '12px', background: '#f59e0b', color: 'white', border: 'none', cursor: 'pointer', boxShadow: 'var(--card-shadow)', fontWeight: 'bold' }}>Push Pebble (s&gt;0)</button>
            <button id="sim1-btn-reset" className="btn secondary-btn" style={{ padding: '0.8rem 1.5rem', borderRadius: '12px', background: '#ef4444', color: 'white', border: 'none', cursor: 'pointer', boxShadow: 'var(--card-shadow)', fontWeight: 'bold' }}>Reset</button>
          </div>
      ...
      <article className="glass-card fade-in" style={{ animationDelay: '0.6s', gridColumn: '1 / -1' }}>
        <div className="info-block" style={{ marginBottom: '2rem' }}>
          ...
          <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-6.png" alt="5N * 2m" style={{ maxWidth: '401px', width: '100%', marginTop: '1rem', borderRadius: '8px' }} />
        </div>
        <div className="info-block">
          <h3>Question</h3>
          ...
          <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-7.png" alt="7N * 8m" style={{ maxWidth: '383px', width: '100%', marginTop: '1rem', borderRadius: '8px' }} />
        </div>
      </article>
      ...
      <article className="glass-card highlight-card fade-in" style={{ animationDelay: '0.7s', gridColumn: '1 / -1' }}>
        ...
        <div className="video-container" style={{ width: '100%', maxWidth: '800px', margin: '0 auto 2rem auto', borderRadius: '16px', overflow: 'hidden', boxShadow: 'var(--card-shadow), var(--inset-shadow)' }}>
          <iframe width="800" height="450" src="https://www.youtube.com/embed/WL7__D14kGc" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen style={{ display: 'block', maxWidth: '100%', height: 'auto', aspectRatio: '16/9' }}></iframe>
        </div>

        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-8.png" alt="Boy pulling car" style={{ maxWidth: '744px', width: '100%', borderRadius: '16px', boxShadow: 'var(--card-shadow)' }} />
        </div>
        ...
        <div className="side-by-side-cards">
          <div className="info-block" style={{ background: 'rgba(16, 185, 129, 0.1)', border: '2px solid var(--success-color)' }}>
            ...
            <div style={{ background: 'white', padding: '1rem', borderRadius: '12px', margin: '1rem 0', textAlign: 'center' }}>
              <img src="\/s/articles/69c110888f3f7b8b1d1f4389/images/image-20260323153602-9.png" alt="Positive work formula" style={{ maxWidth: '365px', width: '100%' }} />
            </div>
            <ul>
      ...
      <article className="glass-card fade-in" style={{ animationDelay: '0.9s', gridColumn: '1 / -1' }}>
        ...
        <div className="simulation-container" style={{ position: 'relative', width: '100%', aspectRatio: '21/9', minHeight: '400px', borderRadius: '24px', overflow: 'hidden', boxShadow: 'var(--inner-well)' }}>
          <canvas id="sim2-canvas" style={{ width: '100%', height: '100%', display: 'block' }}></canvas>
          
          <div className="sim-ui" style={{ position: 'absolute', bottom: '1.5rem', left: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <button id="sim2-btn-pull" className="btn primary-btn" style={{ padding: '0.8rem 1.5rem', borderRadius: '12px', background: 'var(--accent-color)', color: 'white', border: 'none', cursor: 'pointer', boxShadow: 'var(--card-shadow)', fontWeight: 'bold' }}>Hold to Pull (140 N)</button>
            <button id="sim2-btn-reset" className="btn secondary-btn" style={{ padding: '0.8rem 1.5rem', borderRadius: '12px', background: '#ef4444', color: 'white', border: 'none', cursor: 'pointer', boxShadow: 'var(--card-shadow)', fontWeight: 'bold' }}>Reset Field</button>
          </div>
          
          <div className="sim-stats glass-card" style={{ position: 'absolute', top: '1.5rem', right: '1.5rem', padding: '1.5rem', background: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(10px)', minWidth: '200px' }}>
            <p style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem' }}>Force: <strong id="sim2-stat-force" style={{ color: 'var(--accent-color)' }}>0 N</strong></p>
            <p style={{ margin: '0 0 0.5rem 0', fontSize: '1.1rem' }}>Displacement: <strong id="sim2-stat-disp" style={{ color: 'var(--accent-color)' }}>0 m</strong></p>
            <div style={{ borderTop: '2px solid rgba(0,0,0,0.1)', margin: '0.8rem 0' }}></div>
            <p style={{ margin: 0, fontSize: '1.2rem' }}>Work Done: <strong id="sim2-stat-work" style={{ color: '#10b981', fontSize: '1.4rem' }}>0 J</strong></p>
          </div>
        </div>
      </article>
...
console.log('ChapterOneThree.jsx regenerated with full correct data and simulations.');
