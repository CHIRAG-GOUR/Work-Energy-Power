...
const ChapterOneThree = () => {
  ...
  return (
    <div id="view-chapter-1.3" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', padding: '1rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      {/* HORIZONTAL CARD: VIDEO AND DIAGRAM */}
      <article className="glass-card fade-in hover-lift" style={{ width: '100%', maxWidth: '1000px', padding: '1.5rem', display: 'flex', flexWrap: 'wrap', gap: '2rem', alignItems: 'center' }}>
        <div style={{ flex: '1 1 450px', display: 'flex', flexDirection: 'column' }}>
            <h3 style={{ marginBottom: '1rem', color: '#1e293b' }}>Introduction</h3>
            <div className="video-container" style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.15)', display: 'flex' }}>
                <iframe style={{ width: '100%', minHeight: '280px', border: 'none' }} src="https://www.youtube.com/embed/d6MhIBpmJnE" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
        </div>
      ...
      {/* HORIZONTAL CARD: MATH DEF */}
      <article className="glass-card fade-in hover-lift" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexWrap: 'wrap', gap: '2rem', alignItems: 'center', padding: '1.5rem' }}>
        <div style={{ flex: '2 1 400px' }}>
            ...
            <p dir="ltr" style={{ color: 'var(--text-dark)', lineHeight: '1.6', margin: 0 }}>When a constant force (<b>F</b>) acts on an object and moves it through a distance (<b>s</b>) in the same direction as the force, the work done (<b>W</b>) is calculated as the product of these two values.</p>
        </div>
        <div style={{ flex: '1 1 250px', background: 'var(--glass-bg)', padding: '1.5rem', borderRadius: '0.75rem', textAlign: 'center', boxShadow: 'var(--inner-well)' }}>
            <p dir="ltr" style={{ fontSize: '1.1rem', color: 'var(--accent-color)', marginBottom: '0.75rem' }}><b>Work = Force &times; Displacement</b></p>      
      ...
      {/* HORIZONTAL CARD: KEY CHARACTERISTICS */}
      <article className="glass-card fade-in hover-lift" style={{ width: '100%', maxWidth: '1000px', padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem' }}>
            <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <div style={{ background: 'white', padding: '1rem', borderRadius: '0.5rem', borderLeft: '4px solid #3b82f6', height: '100%' }}>
                    <b>Scalar Quantity:</b> Work has magnitude only, no direction. Even though force and displacement are vectors, their product (work) is just a value.
                </div>
            </div>
            <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <div style={{ background: 'white', padding: '1rem', borderRadius: '0.5rem', borderLeft: '4px solid #f59e0b', height: '100%' }}>
                    <b>The Unit (The Joule):</b> The standard unit is the Newton-metre (N m), renamed the <b>Joule (J)</b>.
                </div>
            </div>
            <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <div style={{ background: 'rgba(16, 185, 129, 0.1)', padding: '1rem', borderRadius: '0.5rem', borderLeft: '4px solid #10b981', height: '100%' }}>
                    <b>Definition of 1 Joule:</b> 1 J is the work done when a force of 1 N displaces an object by 1 m in the direction of the force.
                </div>
            </div>
        </div>
      </article>
      ...
      <article className="glass-card fade-in" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1.5rem' }}> 
        <h2 dir="ltr" style={{ textAlign: 'center', margin: '0 0 1rem 0' }}>Analyzing the "Zero Work" Conditions</h2>
      ...
      {/* TABLE SUMMARY */}
      <article className="glass-card fade-in hover-lift" style={{ width: '100%', maxWidth: '1000px', padding: '0', overflow: 'hidden' }}> 
      ...
      <article className="glass-card fade-in" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', padding: 0, overflow: 'hidden' }}>
        ...
        <div style={{ minHeight: '380px', backgroundColor: '#f8fafc', position: 'relative' }}>
      ...
      <article className="glass-card fade-in" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', gap: '1rem', background: 'rgba(255, 255, 255, 0.5)', padding: '1.5rem' }}>
          <div style={{ background: 'white', padding: '1.25rem', borderRadius: '1rem', border: '1px solid #f1f5f9' }}>
              ...
              <p style={{ fontSize: '0.95rem', color: 'var(--text-dark)', margin: 0 }}>Lift the object up using the simulation above. Two active forces are at play.</p>
              <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1rem', flexWrap: 'wrap' }}>
                 <div className="hover-lift" style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', padding: '1rem', borderRadius: '1rem', flex: '1 1 300px', transition: 'all 0.3s ease' }}>
                 ...
                 <div className="hover-lift" style={{ background: '#fef2f2', border: '1px solid #fecaca', padding: '1rem', borderRadius: '1rem', flex: '1 1 300px', transition: 'all 0.3s ease' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
      ...
      {/* FINAL EXAMPLES & EXERCISE - HORIZONTAL */}
      <article className="glass-card fade-in hover-lift" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'center' }}>
              <div style={{ flex: '1 1 400px', background: 'var(--glass-bg)', padding: '1.5rem', borderRadius: '0.75rem', fontStyle: 'italic', color: '#334155' }}>
              ...
              <div style={{ flex: '1 1 300px', background: 'white', padding: '1.25rem', borderRadius: '0.75rem', borderLeft: '4px solid #06b6d4', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
      ...
      <article className="glass-card fade-in" style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', padding: '1.5rem' }}>
          ...
          <div style={{ flexGrow: 1, display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
              <div className="hover-lift" style={{ flex: '1 1 300px', background: 'white', padding: '1rem', borderRadius: '0.75rem', display: 'flex', gap: '1rem', boxShadow: '0 2px 4px rgba(0,0,0,0.02)', transition: 'all 0.3s ease', alignItems: 'center' }}>
              ...
              <div className="hover-lift" style={{ flex: '1 1 300px', background: 'white', padding: '1rem', borderRadius: '0.75rem', display: 'flex', gap: '1rem', boxShadow: '0 2px 4px rgba(0,0,0,0.02)', transition: 'all 0.3s ease', alignItems: 'center' }}>
                  ...
                  <p style={{ fontSize: '0.9rem', margin: 0, color: '#334155' }}>Write an expression for the work done...</p>
              </div>
              <div className="hover-lift" style={{ flex: '1 1 300px', background: 'white', padding: '1rem', borderRadius: '0.75rem', display: 'flex', gap: '1rem', boxShadow: '0 2px 4px rgba(0,0,0,0.02)', transition: 'all 0.3s ease', alignItems: 'center' }}>
